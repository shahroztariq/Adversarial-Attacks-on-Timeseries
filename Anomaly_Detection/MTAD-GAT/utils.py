...
# class SlidingWindowDataset_FGSM(Dataset):
#     def __init__(self, data, window, target_dim=None, horizon=1,model=None):
#         self.data = data
#         self.window = window
#         self.target_dim = target_dim
#         self.horizon = horizon
...
#         # x = fast_gradient_method(self.model, x, FLAGS.eps, np.inf, y=y)
#         return x, y
#
#     def __len__(self):
#         return len(self.data) - self.window
